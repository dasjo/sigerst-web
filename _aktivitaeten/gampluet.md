...
saison:
  monate: [5, 6, 7, 8, 9, 10]
  hinweis: "Gondelbahn saisonal in Betrieb (solarbetrieben) – Alternative zur Wanderung"
gpx: /assets/gpx/gampluet.gpx
gpx_quelle: BRouter (OSM-Wanderwegnetz), grob aufgelöst – Verlauf prüfen
start:
  name: Lisighaus (Talstation Gamplütbahn), Wildhaus
